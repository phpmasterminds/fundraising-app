  ...
  const committedBanner = priorRoundsCumulative > 0 ? (
    <div className="bf-card" style={{ background:'#EAF6F5', border:'1px solid #2BA7A0', borderRadius:16, padding:'14px 16px', margin:'0 0 16px' }}>
      <p style={{ margin:0, fontSize:13, color:'#16837E', fontWeight:600 }}>
        The amount matched in this round will be added to your total.
      </p>
    ...
    <IonPage><IonContent fullscreen className="bf-page" scrollY>
      ...
      <div className="bf-results-wrap">
        ...
        <div className="bf-card bf-card--row bf-card--cumul">
          <div>
            <p className="bf-card-title bf-card-title--sm">Total Matched Amount (Across All Rounds)</p>
            <p className="bf-card-lbl" style={{ marginTop: 2 }}>Your total amount due so far</p>
          </div>
